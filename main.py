# Task1
# Я не знала нужно ли учитывать в задании тип данных/
# и воспользовалась конструкцией try except. Нужно ли  было/
# от пользователя добиться корректного ввода данных?
a = "text"
b = 2
c = [1, 2]
d = {1: 'Vanya'}
